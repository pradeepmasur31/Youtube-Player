...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY = "AIzaSyC0ndYwSjELvWjMK1H2Xg-5nYDmprPMVRM";
    static final String YOUTUBE_VIDEO_ID = "rX3apDEaHwA";
    static final String YOUTUBE_PLAYLIST = "PLmeV8ZVt-O8U-1oaw-gAZcWO_TMhNhhDz";
...
//        ConstraintLayout constraintLayout = (ConstraintLayout) findViewById(R.id.activity_youtube);
        @SuppressLint("InflateParams") ConstraintLayout layout = (ConstraintLayout) getLayoutInflater().inflate(R.layout.activity_youtube, null);
